...
// routes
import 'package:maven_market/tabs/Watchlists.dart';
...
class _SectorsState extends State<Sectors> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<dynamic> secInd = [['abc',5,20.5],['abc',5,20.5],['abc',5,20.5]];
    return Column(
      children: <Widget>[
              ...
              actions: <Widget>[
                StatefulBuilder(
                  builder: (BuildContext context, StateSetter setState) {
                    return IconButton(
                      color: isListBookmark ? const Color.fromRGBO(240, 154, 105, 1) : null,
